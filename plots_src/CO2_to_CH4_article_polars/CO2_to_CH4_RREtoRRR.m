%%CO2->CH4 wave refraction with chi=.78...
    %%... and beta=34.37°. RRE<->RRR transition.
...
beta=34.37*pi/180; %shock-interface angle in rad
...
legend('Incident CO2 polar','Transmited CH4 polar',...
    'incident \xi','y axis')
title("Shock polars for CO2->CH4 refraction (s->f) with \beta=34.37° and \chi=.78")
xlabel('\delta (rad)')
ylabel('\xi')
