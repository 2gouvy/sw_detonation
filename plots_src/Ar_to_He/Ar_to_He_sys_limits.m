...
%gas parameters
    ...
    gamma_I=1.667; %slow material, first phase
...
%Computing RRR<->BPR limit in omega-xi plane:
    ...
    chis_RRR_BPR=linspace(.67,1,nchis);%chi coordinates
...
%Computing BPR<->NFR boundary
    ...
    for i=1:ny_BPR_NFR
        omegas_BPR_NFR(i)=bPRFNROmega(1/chis_BPR_NFR(i),gamma_I,gamma_II...
            ,mu_I,mu_II);
    end
...
incident_Mach_shock_BPR_NFR=arrayfun(@xiToMach,1./chis_BPR_NFR)
